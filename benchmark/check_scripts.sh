...
bash -n "$root_dir/benchmark/check_tournament_guards.sh"
...
bash -n "$root_dir/benchmark/check_qwen35_cpu_logits.sh"
...
bash -n "$root_dir/tools/fortai-server"
...
bash "$root_dir/benchmark/check_tournament_guards.sh" >/dev/null
