...
`8c8407f93ea086aa73d3d2a09dadd466ae73780b`. It refuses a resident
...
the matched-forward metric, positive timing steps, and positive token/context
workload dimensions, and checks the independent centered-logit oracle.
